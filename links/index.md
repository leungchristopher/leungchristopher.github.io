...
<p class="lede">People whose work I find interesting, and keep going back to. A running list.</p>

## Machine learning

- [Chris Olah](https://colah.github.io/): interpretability, explained with the diagrams I wish new papers have.
- [Lilian Weng](https://lilianweng.github.io/): the best primers for topics in ML!
- [Sebastian Raschka](https://magazine.sebastianraschka.com/): a clear distillation of how modern LLMs work.

## Neuroscience and genetics
- [Google DeepMind neuroscience](https://kevinjmiller.org/neuroscience-at-google-deepmind/): a real treasure trove of ideas.

## CS and mathematics

- [Timothy Gowers](https://gowers.wordpress.com/): clear mathematical exposition.
